...
const UpdatePuppyModal = ({ show, handleClose, puppyId, onPuppyUpdated }) => {
  ...
  useEffect(() => {
    console.log(puppyId, show);
    if (show && puppyId) {
      const puppy = puppies.find(
        (puppy) => puppy.puppyId === parseInt(puppyId)
      );
  ...
  const handleSubmit = async (e) => {
    ...
    const success = await dispatch(updatePuppy(puppyId, updatedPuppy));
